...
void Drive::drive_to_pose(float X_position, float Y_position, float angle, float lead) {
  drive_to_pose(X_position, Y_position, angle, lead, boomerang_setback, drive_min_voltage, drive_max_voltage, heading_max_voltage, drive_settle_error, drive_settle_time, drive_timeout, drive_kp, drive_ki, drive_kd, drive_starti, heading_kp, heading_ki, heading_kd, heading_starti);
}
